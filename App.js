...
*/
  ...
  return (
    <div className="App">
    <div className="game">Spin Game</div>    
    <div className="table1">
    <div className="tr">
        <div className="td"> Click Start/Stop for Spin
        <label className="scircle"></label>
        <button id="" className="spinbutton" onClick={Spin}>SPIN</button> 
        <button id="" className="spinbutton" onClick={Stop}>STOP</button> 
         </div>    
    <div className="td"> Spin Game 
        <br/>Participant List
        <div className="item">
